...
wit handles large files natively with automatic chunking - no Git LFS required.

## Overview

Unlike Git, which struggles with large files and requires Git LFS for efficient handling, wit includes built-in large file support:
