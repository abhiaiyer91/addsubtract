...
wit exposes Prometheus-compatible metrics at `/metrics`:
...
http_requests_total{method="GET",path="/health"} 1250
# TYPE db_health_check_latency_ms histogram
db_health_check_latency_ms_count 1250
db_health_check_latency_ms_avg 4.2
```
