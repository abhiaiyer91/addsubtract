---
title: "Stacked Diffs"
description: "Break down large features into smaller, dependent branches with stacked diffs"
---

# Stacked Diffs

Stacked diffs allow you to break down large features into smaller, dependent branches that build on top of each other. This makes code review easier and allows for incremental merging.

## Overview

Traditional development often leads to large, monolithic pull requests that are hard to review. Stacked diffs solve this by:

- Breaking features into logical, reviewable chunks
- Maintaining dependencies between branches
- Automating rebasing when base changes
- Enabling parallel review of dependent changes
